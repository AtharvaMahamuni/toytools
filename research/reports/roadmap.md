...
- **Health Date Calculation** (datetime) - 3 tool(s), mean score 83.3.
- **Energy And Nutrition Planning** (wellness) - 3 tool(s), mean score 82.6.
- **Fitness Performance Calculation** (wellness) - 3 tool(s), mean score 82.4.
...
- **Body Composition Calculation** (wellness) - 3 tool(s), mean score 79.5.
...
- **Personal Health Logging** (tracker) - 2 tool(s), mean score 77.9.
...
- **Schedule Expression Translation** (datetime) - 1 tool(s), mean score 69.9.
...
- **Shell Quoting** (encoding) - 1 tool(s), mean score 66.5.
- **Salary Conversion** (budget) - 1 tool(s), mean score 66.3.
- **Retirement Projection** (retirement) - 1 tool(s), mean score 61.4.
- **Nutrition Authoring** (meal-planning) - 1 tool(s), mean score 46.6.

## Emerging trends (by transformation)
- Health Date Calculation: 3 signal(s), mean demand 0.82, mean score 83.3.
- Energy And Nutrition Planning: 3 signal(s), mean demand 0.77, mean score 82.6.
- Fitness Performance Calculation: 3 signal(s), mean demand 0.78, mean score 82.4.
- Body Composition Calculation: 3 signal(s), mean demand 0.52, mean score 79.5.
- Personal Health Logging: 2 signal(s), mean demand 0.56, mean score 77.9.
