...
export const md5: HashTool = {
  ...
  insight:
    'MD5 produces a 128-bit checksum. It is fast but cryptographically broken, and collisions are practical, so use it only for non-security checks like deduplication or cache keys, never passwords or signatures.',
  technical: [
    ...
    { term: 'Security', detail: 'Broken: collisions are practical, so not for security' },
  ],
  hash: md5hex,
};
