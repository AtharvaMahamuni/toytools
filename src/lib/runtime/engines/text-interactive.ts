...
import { explainSummary, looksExpensive, runRegexTest, workerSource } from '@lib/text/regex-tester';
...
export const attach: AttachFn = (TT) => {
  ...
  TT.regex = { test: runRegexTest, looksExpensive, explainSummary, workerSource };
};
