...
export const items: FAQItem[] = [
  ...
  {
    id: 'uc-faq-2',
    question: 'Does uppercase change numbers or punctuation?',
    answer:
  ...
  {
    id: 'uc-faq-3',
    question: 'Why does text look uppercase on a page but paste as lowercase?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Accented letters keep their accents when uppercased, so "é" becomes "É", not a plain "E". For example, "café résumé" converts to "CAFÉ RÉSUMÉ"; if you expected bare capitals, the accents staying put is correct Unicode behaviour, not a bug. One genuine surprise is the German "ß", which expands to "SS" and makes the result one character longer per occurrence.',
  },
];
