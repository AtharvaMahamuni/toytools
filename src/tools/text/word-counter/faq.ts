...
export const items: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'No. Counting runs entirely in your browser. Your writing never leaves your device.',
  },
  {
    id: 'wc-faq-5',
    question: 'How long does it take to read 1000 words?',
    answer:
      'At an average adult reading speed of around 200 to 250 words per minute, 1000 words takes approximately 4 to 5 minutes to read. Reading time estimates are averages: technical text with complex vocabulary takes longer than casual prose. This tool calculates an estimated reading time based on a 200 wpm average.',
  },
  {
    id: 'wc-faq-6',
  ...
  },
  {
    ...
    answer:
      'Counters differ in how they handle edge cases: hyphenated words (1 word or 2?), contractions (1 word), lines with only punctuation, multiple consecutive spaces, and dashes without spaces. Most differences are small. For academic submissions where the exact count matters, use the counter specified by your institution or submission system.',
  },
  {
    id: 'wc-faq-8',
    question: 'How is reading time calculated?',
    answer:
      'Reading time is estimated by dividing the word count by a typical reading speed. The most common reference is 200 words per minute for average adult reading of prose. At that rate, a 1,000-word article takes 5 minutes. Some tools use 250 wpm. Technical documentation is slower, around 100 to 150 wpm.',
  },
  {
    id: 'wc-faq-9',
