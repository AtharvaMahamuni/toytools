...
export const config: ToolConfig = {
  ...
  description: 'Add, subtract, multiply, or divide fractions and mixed numbers with every step shown: the LCD, the conversion, and the simplification, plus mixed and decimal forms.',
