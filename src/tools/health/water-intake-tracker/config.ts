...
export const config: ToolConfig = {
  ...
  description: 'Track how much water you drink each day, hit your goal and build a streak. A private hydration tracker with a weekly chart, right in your browser.',
