...
export const items: FAQItem[] = [
  ...
  {
    id: 'ef-faq-2',
    question: 'Can I target 8 months of expenses?',
    answer:
  ...
  {
    id: 'ef-faq-3',
    question: 'Should the fund be based on income or expenses?',
    answer:
  ...
  {
    id: 'ef-faq-7',
    question: 'What counts as a monthly expense for this?',
    answer:
  ...
  {
    id: 'ef-faq-8',
    question: 'How do I build my emergency fund?',
    answer:
