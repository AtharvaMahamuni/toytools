...
export const items: FAQItem[] = [
  ...
  },
  {
    ...
    question: 'How is this different from a password generator?',
    answer:
  ...
  },
  {
    ...
    question: 'Can I use a custom character set?',
    answer:
      'Yes. Put your own list of allowed characters in the custom field. For example, `ABCDEF0123456789` limits the string to those characters only. This is useful when a system accepts a limited alphabet, such as hexadecimal only or letters without symbols. The custom set overrides the on-off toggles when it is filled in.',
  },
  {
