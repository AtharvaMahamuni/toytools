...
export const config: ToolConfig = {
  ...
  description: 'Count the duration between two dates in years, months and days, the days until a future date, plus totals in weeks and the number of weekdays.',
