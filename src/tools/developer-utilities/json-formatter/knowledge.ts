...
export const knowledge: Knowledge = {
  ...
  primaryConcepts: ['json formatter'],
  secondaryConcepts: ['json', 'pretty print', 'beautify', 'indentation', 'JSON formatting'],
  intentGroups: {
    informational: ['What is JSON formatting?', 'What is pretty-printing?'],
    howTo: ['How to format an API response', 'How to read minified JSON', 'How do I format JSON online?'],
    comparison: ['Formatting vs minifying', 'Formatting vs validating JSON'],
