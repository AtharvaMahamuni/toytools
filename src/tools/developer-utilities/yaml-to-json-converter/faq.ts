...
export const items: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Yes. All conversion happens entirely in your browser using JavaScript. Your data never leaves your machine, so there is no upload, no server-side processing, and no logging of any kind. This makes the tool safe to use with internal configuration files or any sensitive data.',
  },
];
