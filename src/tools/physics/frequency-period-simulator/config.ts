...
export const config: ToolConfig = {
  ...
  description: 'See how frequency and period are two views of the same motion. Tap a beat or drag the slider and watch the oscillator, period, and angular frequency update live.',
